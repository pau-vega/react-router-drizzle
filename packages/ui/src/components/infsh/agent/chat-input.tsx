...
import {
  ...
  type FileUpload,
} from "@ui/components/infsh/agent/file-upload"
...
export const ChatInput = memo(function ChatInput({
  ...
  const { uploads, addFiles, removeUpload, clearAll, getUploadedFiles, hasPendingUploads, hasCompletedUploads } =
    useFileUploadManager()
  ...
  return (
    <div className="relative">
      ...
      >
        {/* File uploads */}
        {uploads.length > 0 && <FileUploadList uploads={uploads} onRemove={removeUpload} className="pb-2" />}
        ...
        <div className="relative">
          <Popover open={showCommandMenu} onOpenChange={setShowCommandMenu}>
            ...
            <PopoverTrigger render={<div className="w-0 h-0 absolute" />}></PopoverTrigger>
