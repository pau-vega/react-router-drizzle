    ...
    <div className={cn('flex flex-col items-start w-fit mb-2', className)}>
      ...
      >
        <div className="flex items-center p-2">
          <CollapsibleTrigger render={<button className="flex items-center gap-2 text-sm text-muted-foreground/50 hover:text-muted-foreground cursor-pointer" />}>{isOpen ? (
                                  ...
                                  {label}
                                </span>{!isOpen && preview}</CollapsibleTrigger>
        </div>
        <CollapsibleContent>
