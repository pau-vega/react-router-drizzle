    ...
    <div className={cn('', className)}>
      ...
      <div className="relative group">
        <div className="absolute right-2 top-2 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger render={<Button size="icon" variant="ghost" onClick={handleCopy} aria-label="Copy logs" disabled={logs[selectedTab] === undefined} />}>{copied ? (
    ...
    <div className={cn('', className)}>
      <div className="relative group">
        <div className="absolute right-2 top-2 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger render={<Button size="icon" variant="ghost" onClick={handleCopy} aria-label="Copy logs" />}>{copied ? (
                                              <Check className="w-4 h-4 text-green-500" />
                                            ) : (
                                              <Copy className="w-4 h-4" />
                                            )}</TooltipTrigger>
