      ...
      <div className={cn('flex flex-col items-start', className)}>
        ...
        >
          <div className="flex items-center px-1 py-0.5">
            <CollapsibleTrigger render={<button className="flex items-center gap-1.5 text-xs text-muted-foreground/50 hover:text-muted-foreground cursor-pointer" />}>{statusIcon}<span className={cn('lowercase', isActive && 'animate-pulse')}>
                                      {functionName} {statusText}
