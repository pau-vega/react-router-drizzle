 ...
 */
export const Message = memo(function Message({ message, truncateUser = false }: MessageProps) {
  ...
  const reasoningContent = message.content?.find((c) => c.type === ChatMessageContentTypeReasoning)?.text
  ...
  return (
    <MessageBubble message={message}>
      {isAssistant && reasoningContent && (
        <MessageReasoning reasoning={reasoningContent} isReasoning={isGenerating && !hasText} />
      )}
