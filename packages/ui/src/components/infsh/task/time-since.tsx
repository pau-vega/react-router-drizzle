...
export const TimeSince = memo(function TimeSince({ start, end, className, parentheses = false }: TimeSinceProps) {
  ...
  return <span className={cn("text-xs", className)}>{parentheses ? `(${formatted})` : formatted}</span>
})
